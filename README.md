...
2. Use Word2vec for tokenizing then embedding the articles
...
5. find the proportion of articles in a year during conflict that are racist
6. compare the proportions between different wars
7. compare proportions bewteen during conflict and 5 years after conflict
8. compare proportions between race in specific conflict versus race not in that conflict
## Current Limitations
